...
For the underlying math see [Models & Theory § 7.8](../theory/index.md). For the runnable end-to-end example see [`examples/09_pca_rates_pnl.py`](https://github.com/ACea15/VALAX/blob/main/examples/09_pca_rates_pnl.py).
